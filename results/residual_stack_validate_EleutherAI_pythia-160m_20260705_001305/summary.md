...
| Q+S same budget | 0.2580 | 78.6765 | -0.1331 | 0.5000 | +0.0000 | True |
| Q+S+L same budget | 0.2572 | 78.4219 | -0.3877 | 0.5000 | +0.0000 | True |
| Residual-stack selector | 0.2568 | 78.1993 | -0.6103 | 0.5000 | +0.0000 | True |
| Sequential QSR | 0.1400 | 80.4295 | +1.6199 | 0.5000 | +0.0000 | True |
| Fixed SPQ-like | 0.2100 | 79.0048 | +0.1951 | 0.5000 | +0.0000 | True |
| Hessian-guided SPQ | 0.2100 | 79.9339 | +1.1242 | 0.5000 | +0.0000 | True |
...
- Selector memory summary: selected=0.2568, global feasible=True, filter fallback layers=0.
- Selected candidate mix: {"q_l": 4}.
- Conditional-overlap diagnostic: Spearman(positive rho, activation gain vs Q-only) = 0.1212 (n=64); negative values mean lower conflict tends to give larger activation gain.
