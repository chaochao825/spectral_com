...
| Interaction-aware two-stage validation | `two_stage_heterogeneous_*` | Exact natural-byte allocation, independent validation reranking, final-test isolation, and heterogeneous quantizer/repair controls. |
