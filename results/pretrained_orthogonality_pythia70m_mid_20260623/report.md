...
- Higher overlap vs additivity: Spearman(|rho_H|, |A_ij|) = 0.1449 (n=36).
- Real degradation: Spearman(|rho_H|, PPL degradation) = 0.1748 (n=36); zero-shot degradation = -0.2754 (n=36).
