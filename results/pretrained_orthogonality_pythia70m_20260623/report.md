...
- Hessian cosine heatmap generated for q/s/r over 6 pretrained model modules.
- Higher overlap vs additivity: Spearman(|rho_H|, |A_ij|) = 0.1249 (n=18).
- Real degradation: Spearman(|rho_H|, PPL degradation) = 0.2941 (n=18); zero-shot degradation = 0.1180 (n=18).
