...
- Largest order gap: layer=head, rq vs qr, loss gap=0.0344, R-first conditional |rho_H|=0.0304, max directional conditional |rho_H|=0.1009.
...
- order_gap_r_first_overlap: Spearman(abs_r_first_conditional_hessian_overlap, abs_loss_gap) = 0.5795 over n=12.
- order_gap_non_r_first_overlap: Spearman(abs_non_r_first_conditional_hessian_overlap, abs_loss_gap) = -0.2465 over n=12.
